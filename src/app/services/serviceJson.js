...
const services = [
  {
    ...
    image: img1,
    bannerImage: img1,
    longDescription: "Our residential interior design services focus on creating beautiful, comfortable, and functional spaces tailored to your needs. We specialize in modern, traditional, and luxury home designs. Our residential interior design services focus on creating beautiful, comfortable, and functional spaces tailored to your needs. We specialize in modern, traditional, and luxury home designs.",
    keyFeatures: [
  ...
  },
  {
    ...
    image: img2,
    bannerImage: img2,
    longDescription: "Our commercial interior design services ensure a professional and inspiring workplace. From corporate offices to retail spaces, we optimize layouts, lighting, and branding elements.",
    keyFeatures: [
  ...
  },
  {
    ...
    image: img3,
    bannerImage: img3,
    longDescription: "Our luxury interior designs bring sophistication and exclusivity to your space. We use high-end materials, custom-made furniture, and exquisite decor to achieve perfection.",
    keyFeatures: [
  ...
  },
  {
    ...
    image: img4,
    bannerImage: img4,
    longDescription: "Our modular kitchen designs focus on maximizing storage, efficiency, and style. We create seamless kitchen layouts with top-quality materials and smart technology.",
    keyFeatures: [
  ...
  },
  {
    ...
    image: img5,
    bannerImage: img5,
    longDescription: "Our furniture and decor services include sourcing, designing, and arranging furniture pieces that complement your interior theme.",
    keyFeatures: [
  ...
  },
  {
    ...
    image: img6,
    bannerImage: img6,
    longDescription: "Our lighting and space planning services help create visually appealing and energy-efficient interiors, enhancing both aesthetics and functionality.",
    keyFeatures: [
