    ...
    return (
        <div className='mb-20 relative text-white'>
            ...
            <div className='w-11/12 absolute top-10 md:top-20 left-1/2 transform -translate-x-1/2 grid grid-cols-2 md:grid-cols-4 gap-6'>
                {
                    status.map(data => <div className='border-[1px] hover:text-blue-500 transition-all border-gray-400 rounded-full flex flex-col items-center justify-center p-1 w-40 h-40 md:w-50 md:h-50 lg:w-72 lg:h-72 cursor-pointer duration-300 hover:shadow-lg hover:shadow-blue-500 text-center shadow-md shadow-blue-500 '>
