    ...
    return (
        <div className='my-32 mb-56 relative'>
            ...
            <div className='grid grid-cols-2 md:grid-cols-4 gap-5 w-11/12 mx-auto 
                ...
                {/* Each card */}
                <div className='flex flex-col justify-center glass shadow-slate-400 items-center p-6 md:p-10 space-y-5 bg-[#ffffff] hover:bg-[#e8e8e8] transition-all shadow-md rounded-md cursor-pointer'>
                    <h2 className='text-2xl font-semibold text-[#54595f]'>Dhaka</h2>
